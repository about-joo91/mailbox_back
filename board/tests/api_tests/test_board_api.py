...
class TestBoardAPI(APITestCase):
    ...
    def test_when_not_author_put_board_content(self) -> None:
        ...
        client = APIClient()
        user = UserModel.objects.create(username="won1", password="1234", nickname="won")
        author = UserModel.objects.create(username="won2", password="1234", nickname="won2")
        author_board = BoardModel.objects.create(title="title", content="content", author=author)
