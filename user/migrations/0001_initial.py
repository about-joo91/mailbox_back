    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reported_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.reporteduser')),
            ],
        ),
        migrations.CreateModel(
            name='MongleGrade',
            fields=[
                ...
                ('mongle', models.URLField(default='https://user-images.githubusercontent.com/55477835/178631292-f381c6e2-2541-4a2c-ba67-b5bb4369e3d0.jpeg')),
