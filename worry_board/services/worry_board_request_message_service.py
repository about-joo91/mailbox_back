...
def create_request_message_data(
    author: str, worry_board_id: int, request_message: Dict
):
    """
    ...
    if get_request_message is False:
        request_message["author"] = author.id
        request_message["worry_board"] = worry_board_id
